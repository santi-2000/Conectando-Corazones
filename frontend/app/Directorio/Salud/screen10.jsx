...
export default function ApoyosSalud() {
  const router = useRouter();
  const [selectedAssociation, setSelectedAssociation] = useState('Hospital Infantil');
  ...
  const associations = [
    {
      ...
      category: 'Salud',
      description: 'Atención médica especializada en pediatría y urgencias para niñas y niños.',
      contact: '(614) 214-4000',
    ...
    },
    {
      ...
      category: 'Salud',
      description: 'Servicios de medicina general y familiar para toda la comunidad. Consultas, vacunación y atención preventiva.',
      contact: '(614) 555-1234',
    ...
    },
    {
      ...
      category: 'Salud',
      description: 'Atención psicológica y psiquiátrica especializada. Terapia individual, familiar y grupal para todas las edades.',
      contact: '(614) 777-8888',
  ...
  const handleLlamar = () => {
    // Hacer llamada
    console.log('Llamar al hospital');
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Apoyos en Salud</Text>
        </View>
